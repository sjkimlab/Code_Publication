...
# Input numbers
dm1=0;		# co-transcriptional degradation rate (unit: 1/s)					# kd1 in the paper
...
T2=228.1;			# when the first RNAP passes transcription terminator (unit: s)		# T2 in the paper
T3=328.7;	# when the last RNAP passes transcription terminator (unit: s)		# T3 in the paper
T1_3=T3-(T2-tt3);		# when the last RNAP passes 3' probing region (unit: s)				# t3' in the paper
km1=0.0176;		# mRNA synthesis rate with an inducer (unit: 1/s)
km2=0.000107;		# synthesis rate of basal level (unit: 1/s)
...
data.to_excel('case2.xlsx', sheet_name='sheet1', index=False)
