classdef Diffusion_Simulator < matlab.apps.AppBase
...
%                 app.Image.ImageSource = cytoplasm_xNorm_load;
                ...
                save('data','tracksFinal','D_list','Alpha_list','MSD_list') %save the variables for future use
...
%             app.UpdateButton_2.Text = 'Update';
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = Diffusion_Simulator
